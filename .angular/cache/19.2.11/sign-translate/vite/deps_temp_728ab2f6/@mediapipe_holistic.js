    ...
    (function() {
      ...
      z("Promise", function(a) {
        ...
        b.prototype.D = function() {
          ...
          "function" === typeof g ? g = new g("unhandledrejection", {
            ...
            cancelable: true
          }) : (g = y.document.createEvent("CustomEvent"), g.initCustomEvent("unhandledrejection", false, true, g));
          g.promise = this;
          g.reason = this.j;
          return k(g);
        };
      ...
      function Kd(a, b) {
        ...
        if (void 0 === a.s) {
          ...
          c.vertexAttribPointer(a.l.N, 2, c.FLOAT, false, 0, 0);
          ...
          switch (p.h) {
            ...
            case 2:
              ...
              if ("object" === typeof window) return Od("createMediapipeSolutionsWasm", {
                ...
                return D(function(n) {
                  a.h.graph && a.h.graph.url ? n = C(n, Td(a, a.h.graph.url), 0) : (n.h = 0, n = void 0);
                  return n;
                });
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.h.options) {
          for (var d = [], e = [], f = {}, g = A(Object.keys(a)), h = g.next(); !h.done; f = {
            X: f.X,
            Y: f.Y
          }, h = g.next()) if (h = h.value, !(h in this.l && this.l[h] === a[h])) {
            this.l[h] = a[h];
            var k = b[h];
            void 0 !== k && (k.onChange && (f.X = k.onChange, f.Y = a[h], d.push(/* @__PURE__ */ function(l) {
              ...
              valueBoolean: 0 === k.type ? a[h] : false,
