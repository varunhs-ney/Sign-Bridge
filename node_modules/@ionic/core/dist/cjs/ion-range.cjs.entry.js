...
const Range = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '124909954930d95f353e8593fd967de1486b0315', onFocusin: this.onFocus, onFocusout: this.onBlur, id: rangeId, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'in-item': inItem,
            ...
            }) }, index.h("label", { key: '0af177a2ba5869d3441c4b3f393835218807a418', class: "range-wrapper", id: "range-label" }, index.h("div", { key: '4d834224b9c834e88497f58af4339348cec9ca1c', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !hasLabel,
            }, part: "label" }, label !== undefined ? index.h("div", { class: "label-text" }, label) : index.h("slot", { name: "label" })), index.h("div", { key: '797d39ac73610f6d81d0b99d71982f98f2a66c88', class: "native-wrapper" }, index.h("slot", { key: '88824589cac5bb2134c30bed067ed11f6e81d887', name: "start" }), this.renderRangeSlider(), index.h("slot", { key: '7207a1164b272f56634435f7bff9114fb5d9f085', name: "end" })))));
    }
