...
it('should parse a prefixed signbox with SignWriting Null', () => {
  expect(parse.sign('AS10011S00000S2e704S2e748M525x535S2e748483x510S10011501x466S2e704510x500S10019476x475')).toEqual({
