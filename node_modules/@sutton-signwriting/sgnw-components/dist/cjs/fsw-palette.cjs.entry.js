...
const FswPalette = class {
  constructor(hostRef) {
    ...
    this.size = "small";
    /** set of symbols */
    this.alphabet = global.iswa2010FSW;
  ...
  render() {
    return (_commonjsHelpers.h(_commonjsHelpers.Host, { class: this.orientation + " " + this.size }, _commonjsHelpers.h("nav", null, _commonjsHelpers.h("fsw-button", { svg: icons.HomeIcon, onClick: () => { this.group = null; } }), this.group ? _commonjsHelpers.h("fsw-button", { svg: icons.ChevronUpIcon, onClick: () => {
        if (this.base) {
          this.base = null;
          this.more = null;
        }
      ...
      } }) : _commonjsHelpers.h("div", null), this.hasMore ? _commonjsHelpers.h("fsw-button", { svg: this.more ? icons.ArrowLeftIcon : icons.ArrowRightIcon, onClick: () => { this.more = !this.more; } }) : (this.size == "small" ? _commonjsHelpers.h("div", null) : null), this.hasLower ? _commonjsHelpers.h("fsw-button", { svg: this.lower ? icons.ArrowUpIcon : icons.ArrowDownIcon, onClick: () => { this.lower = !this.lower; } }) : (this.size != "large" ? _commonjsHelpers.h("div", null) : null)), _commonjsHelpers.h("main", null, this.palette.map(key => _commonjsHelpers.h("fsw-palette-symbol", { symbol: key })))));
  }
...
exports.fsw_palette = FswPalette;
