...
const swu = require('./swu-8ca7dadc.js');
...
const SgnwButton = class {
  ...
  render() {
    ...
    let svg = '';
    if (this.symbol) {
      svg = this.sgnw ? swu.swu.symbolSvg(this.symbol + styleStr) : '';
    }
    else if (this.sign) {
      svg = this.sgnw ? swu.swu.signSvg(this.sign + styleStr) : '';
    }
    else if (this.svg) {
      svg = this.svg;
    }
...
const SgnwPaletteSymbol = class {
  ...
  render() {
    return (_commonjsHelpers.h(_commonjsHelpers.Host, { symbol: this.symbol, innerHTML: this.sgnw ? swu.swu.symbolSvg(this.symbol) : '' }));
  }
  get el() { return _commonjsHelpers.getElement(this); }
};
SgnwPaletteSymbol.style = sgnwPaletteSymbolCss;

exports.sgnw_button = SgnwButton;
exports.sgnw_palette_symbol = SgnwPaletteSymbol;
