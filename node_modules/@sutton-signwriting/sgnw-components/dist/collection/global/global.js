...
export const cssValues = function (el) {
...
export const padArray = function (arr, len) {
  if (len < arr.length) {
    len = len * 2;
  }
  return arr.concat(Array(len - arr.length).fill(null));
};
export const padArrayInner = function (arr, segment, len) {
  let padded = [];
  let slice;
...
export const hasSize = function (symbolId) {
