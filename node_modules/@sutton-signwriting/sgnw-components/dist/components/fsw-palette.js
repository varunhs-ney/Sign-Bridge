...
import { i as iswa2010FSW, p as padArrayInner, b as padArray, h as hasSize } from './global.js';
import { d as defineCustomElement$3 } from './fsw-button2.js';
import { d as defineCustomElement$2 } from './fsw-palette-symbol2.js';
...
const FswPalette$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return fswPaletteCss; }
}, [2, "fsw-palette", {
    "orientation": [1],
    "size": [1],
    "alphabet": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["fsw-palette", "fsw-button", "fsw-palette-symbol"];
  components.forEach(tagName => { switch (tagName) {
    case "fsw-palette":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, FswPalette$1);
      }
      break;
    case "fsw-button":
      if (!customElements.get(tagName)) {
...
const FswPalette = FswPalette$1;
const defineCustomElement = defineCustomElement$1;

export { FswPalette, defineCustomElement };
