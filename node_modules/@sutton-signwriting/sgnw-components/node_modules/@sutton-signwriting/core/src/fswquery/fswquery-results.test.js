...
it('should return matching signs', () => {
  expect(results('QAS1eb20T', signtext)).toEqual(['AS1eb20S15a37S26507S26507S15a10S15a18S22b04S22b14M530x550S15a37470x456S15a10515x523S15a18481x523S1eb20490x468S22b14479x488S26507504x450S22b04514x489S26507516x460', 'AS1eb20S15a06S29b0bM516x531S15a06484x468S1eb20492x483S29b0b484x496']);
  expect(results('QAS20350S203uuTS22f04S301uu480x480', signtext)).toEqual(['AS20350S20358S22f04S22f14S30114M528x565S20350508x530S20358477x530S22f04503x551S22f14471x551S30114482x477']);
})

it('should return lines with matching sign at start', () => {
  expect(lines('QAS1eb20T', signlines)).toEqual(['AS1eb20S15a37S26507S26507S15a10S15a18S22b04S22b14M530x550S15a37470x456S15a10515x523S15a18481x523S1eb20490x468S22b14479x488S26507504x450S22b04514x489S26507516x460 this line here', 'AS1eb20S15a06S29b0bM516x531S15a06484x468S1eb20492x483S29b0b484x496 this line here']);
  expect(lines('QAS20350S203uuTS22f04S301uu480x480', signlines)).toEqual(['AS20350S20358S22f04S22f14S30114M528x565S20350508x530S20358477x530S22f04503x551S22f14471x551S30114482x477 this line here']);
})
