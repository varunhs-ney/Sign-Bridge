 ...
 * return '#0000CC'
 */
export function colorize(swuSym: string): string;
/**
 ...
 * }
 */
export function columns(swuText: string, options: ColumnOptions): {
    options: ColumnOptions;
    widths: number[];
    columns: ColumnData;
};
export namespace compose {
    function symbol(swuSymObject: SymbolObject): string;
    function sign(swuSignObject: SignObject): string;
}
/**
 ...
 * return '\\uD8C0\\uDC01\\uD836\\uDD06\\uD836\\uDD06'
 */
export function encode(swu: string): string;
/**
 ...
 * }
 */
export function info(swu: string): SegmentInfo;
/**
 ...
 * return true
 */
export function isType(swuSym: string, type: string): boolean;
/**
 ...
 * return ['D8C0', 'DC01']
 */
export function pair(swuChar: string): string[];
export namespace parse {
    export function symbol_1(swuSym: string): SymbolObject;
    export { symbol_1 as symbol };
    export function sign_1(swuSign: string): SignObject;
    export { sign_1 as sign };
    export function text(swuText: string): string[];
}
/**
