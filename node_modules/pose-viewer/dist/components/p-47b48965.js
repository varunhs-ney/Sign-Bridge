...
const BUILD = /* pose-viewer */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: true, cssAnnotations: true, devTools: false, disconnectedCallback: true, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", invisiblePrehydration: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: false, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, slot: false, slotChildNodesFix: false, slotRelocation: false, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: false, vdomClass: false, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: false, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: true };
...
const PoseViewer = /*@__PURE__*/ proxyCustomElement(class PoseViewer extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h$1(Host, null, render));
    }
    get element() { return this; }
    static get watchers() { return {
        "src": ["srcChange"]
    }; }
    static get style() { return PoseViewerStyle0; }
}, [1, "pose-viewer", {
        "src": [1],
        "svg": [4],
        "width": [1],
...
function defineCustomElement() {
    ...
    const components = ["pose-viewer"];
    components.forEach(tagName => { switch (tagName) {
        case "pose-viewer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PoseViewer);
            }
            break;
    } });
}

export { PoseViewer as P, setNonce as a, setPlatformOptions as b, defineCustomElement as d, getAssetPath as g, setAssetPath as s };

//# sourceMappingURL=p-47b48965.js.map